					...
					$(page.data).each(function () {
						arr.push(`
							<tr>
								...
								<td><a style="text-decoration: none; cursor: pointer;" href="/workbench/clue/detail.html?id=`+this.id+`">`+this.fullName+`</a></td>
								<td>`+this.company+`</td>
								<td>`+this.phone+`</td>
								<td>`+this.mphone+`</td>
								<td>`+this.source+`</td>
				  ...
				  <div class="form-group">
				    <div class="input-group">
					  ...
					  <select name="state" class="form-control">
						  <option value="">--请选择--</option>
						  <c:forEach items="${valueMap.returnState}" var="s">
							  <option value="${s.value}">${s.text}</option>
						  </c:forEach>
					  </select>
				    </div>
